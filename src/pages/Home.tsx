...
import { HomeOutlined, DollarOutlined, 
    BookOutlined, ShoppingOutlined, CoffeeOutlined, 
    CarOutlined, MedicineBoxOutlined, BankOutlined, 
    AlertOutlined, HeartOutlined, IdcardOutlined } from "@ant-design/icons";
